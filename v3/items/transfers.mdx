...
<Warning>
**⚠️ Item Transfer & Locking Not Yet Available in v3 SDK**

The methods `Connect.transferItem()`, `Connect.lockItems()`, `Connect.unlockItems()`, and `Connect.getLockedItems()` are **not yet available** in the v3 SDK (`@handcash/sdk`), even though they are documented below.

**For now, use the v2 fallback documentation:**
- [Item Transfers (v2)](/v2/handcash-connect/send-item)
- [Item Locking (v2)](/v2/handcash-connect/manage-items)

This page will be updated when these endpoints are added to the v3 SDK.
</Warning>
