...
This is fallback documentation for item locking features not yet available in v3 SDK. 
For inventory management available in v3, use the [v3 documentation](/v3/items/inventory).
</Warning>
