...
- Transaction, signature, disclosure, and destructive methods may open a
  second action-specific prompt.
- Item, token, and index reads have separate scopes; a general connection does
  not expose all wallet inventory.
- Market, migration, handle-claim, and administrative helpers are restricted
  to HandCash-owned hosts.
