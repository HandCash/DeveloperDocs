...
A timeout is not a failure — the wallet may finish an action after your request drops. Check `listActions` by label before retrying a payment. Codes are listed in [Local bridge](/brc-wallet/local-bridge).
