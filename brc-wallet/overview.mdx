...
- **[Wallet interactions](/brc-wallet/interactions)** — every app-facing method, permission level, and supported item/token scope
- **[Examples](/brc-wallet/examples)** — payments, staged actions, item and token minting, receiving, signing, encryption, and certificates
- **[Local bridge](/brc-wallet/local-bridge)** — connect to Desktop on loopback, discover the wallet, and handle permissions and errors
